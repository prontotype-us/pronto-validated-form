...
(function() {
  ...
  ValidatedFormMixin = {
    ...
    validate: function() {
      return helpers.compactObj(helpers.mapObjKey(this.props.fields || this.fields, (function(_this) {
    ...
    values: function() {
      return helpers.mapObjKey(this.props.fields || this.fields, (function(_this) {
        return function(field_name) {
          var ref;
    ...
    renderFields: function() {
      ...
      return React.createElement("div", null, Object.keys(fields).map((function(_this) {
        return function(field_name) {
  ...
  ValidatedField = React.createClass({displayName: "ValidatedField",
    ...
    render: function() {
      var _value, dashless, form_group_class, form_group_class_set, value;
      ...
      }) : void 0), this.props.label || helpers.humanize(this.props.name)) : void 0), ((function() {
