...
var React, Toggle, ValidatedField, ValidatedForm, ValidatedFormMixin, classSet, helpers, validation;
...
ValidatedFormMixin = {
  ...
  values: function() {
    return helpers.mapObjKey(this.props.fields, (function(_this) {
      return function(field_name) {
        var _ref;
        return (_ref = _this.refs[field_name]) != null ? _ref.value() : void 0;
      };
    })(this));
  },
  trySubmit: function(e) {
    ...
    if (!this.state.loading) {
      ...
      if (Object.keys(errors).length > 0) {
        ...
        values = this.values();
        return typeof (_base = this.props.onSubmit || this.onSubmit) === "function" ? _base(values) : void 0;
      }
    }
  },
...
ValidatedField = React.createClass({
  ...
  render: function() {
    var dashless, form_group_class, form_group_class_set, value, _value;
    if (this.isHidden()) {
    ...
    }, (this.props.type !== 'hidden' ? React.createElement("label", {
...
ValidatedForm = React.createClass({
  ...
  render: function() {
    ...
    }, this.renderFields(), React.createElement("button", null, (this.state.loading ? "Loading..." : "Submit")));
  }
});
