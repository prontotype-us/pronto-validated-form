...
ValidatedFormMixin = {
    ...
    if (!this.state.loading) {
      ...
      if (Object.keys(errors).length > 0) {
        ...
        if (this.props.onSubmit != null) {
          return typeof (base = this.props).onSubmit === "function" ? base.onSubmit(values, this.onUpdated) : void 0;
  ...
  renderFields: function() {
    console.log('[ValidatedFormMixin.renderFields] @props =', this.props);
    console.log('[ValidatedFormMixin.renderFields] @state =', this.state);
...
Checkbox = React.createClass({displayName: "Checkbox",
  ...
  render: function() {
    return React.createElement("div", {
      ...
      "className": "fa fa-" + this.props.icon
    }) : void 0), React.createElement("span", null, this.props.label || helpers.humanize(this.props.name))));
  }
});
